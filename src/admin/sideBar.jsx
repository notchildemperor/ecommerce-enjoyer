...
const SideBar = () => {
    ...
    const [adminName, setAdminName] = useState('Not Signed In');
    const [isDropDownOpen, setIsDropDownOpen] = useState(false);
    const dropdownRef = useRef(null);

    useEffect(() => {
        // Periksa apakah TokenAdmin ada di localStorage
      ...
      const handleLogOut = () => {
        if (isAuthenticated) {
          // Log out: hapus TokenAdmin dari localStorage jika pengguna mengkonfirmasi
          const confirmed = window.confirm("Mau Log-out?");
          if (confirmed) {
          ...
          // Log in: alihkan ke halaman login
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className={`${adminName === 'Not Signed In' ? 'text-red-600' : ''} flex-1 ms-3 whitespace-nowrap`}>
                {adminName}
              </span>
            </a>
         </li>
